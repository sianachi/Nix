...
public sealed class NixTokenValidatorTests
{
        ...
        string secondAudience)
    {
        ...
        var validator = new NixTokenValidator(new RegistrationDirectory(registrations), keyClient);
        ...
        Assert.Equal(firstTenant, Assert.IsType<ValidatedToken>(first).Registration.TenantId);
        Assert.Equal(secondTenant, Assert.IsType<ValidatedToken>(second).Registration.TenantId);
    ...
    public async Task Cross_tenant_audiences_are_refused_regardless_of_claim_order(string ordered)
    {
        ...
        var validator = new NixTokenValidator(directory);
    ...
    public async Task Audiences_for_one_provider_are_coalesced_regardless_of_claim_order(string ordered)
    {
        ...
        Assert.Equal(tenant, validated.Registration.TenantId);
    ...
    public async Task Concurrent_unknown_key_ids_trigger_one_provider_refresh()
    {
        ...
        var validator = new NixTokenValidator(new RegistrationDirectory(registrations), client, clock);
