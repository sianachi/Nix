...
namespace Nix.Persistence.Migrations.Generated
{
    ...
    [Migration("20260923212711_CollabWorkspaceRetentionRead")]
    partial class CollabWorkspaceRetentionRead
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Nix.Domain.Content.PetPreferences", b =>
                {
                    ...
                    b.ToTable("pet_preferences", null, t =>
                        {
                            t.HasCheckConstraint("pet_preferences_bounded", "octet_length(settings::text) <= 65536 AND revision > 0");
                        });
                });
            ...
            modelBuilder.Entity("Nix.Domain.Identity.Principal", b =>
                {
                    ...
                    NpgsqlIndexBuilderExtensions.IncludeProperties(b.HasIndex("TenantId", "Id"), new[] { "DisplayName", "Email" });
            ...
            modelBuilder.Entity("Nix.Domain.Identity.WorkspaceInvitation", b =>
                {
                    ...
                    b.HasIndex("TenantId", "TargetPrincipalId");
                    ...
                    b.HasIndex("TenantId", "WorkspaceId", "TargetPrincipalId")
                        .IsUnique()
            ...
            modelBuilder.Entity("Nix.Domain.Workers.WorkerJob", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("worker_job", (string)null);
                });

            modelBuilder.Entity("Nix.Domain.Workers.WorkerOutboxEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("event_id");
                    ...
                    b.HasIndex("ProcessedAt", "AvailableAt", "LeaseUntil");

                    b.HasIndex("TenantId", "ItemId", "AggregateVersion");

                    b.ToTable("worker_outbox_event", (string)null);
                });
            ...
            modelBuilder.Entity("Nix.Domain.Identity.WorkspaceInvitation", b =>
                {
                    ...
                    b.HasOne("Nix.Domain.Identity.Principal", null)
                        .WithMany()
                        .HasForeignKey("TenantId", "TargetPrincipalId")
                        .HasPrincipalKey("TenantId", "Id")
                        .OnDelete(DeleteBehavior.Restrict);
