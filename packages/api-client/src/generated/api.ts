...
export interface paths {
  ...
  '/api/v1/workspaces/{workspaceId}': {
    ...
    delete: operations['PurgeWorkspace'];
    options?: never;
    head?: never;
  ...
  '/api/v1/workspaces/{workspaceId}/items/trash': {
    ...
    /**
     * Recoverable items in the workspace trash
     * @description Returns directly deleted items the caller may read, newest first. Descendants hidden by a deleted ancestor are not independently trashed.
     */
  ...
  '/api/v1/workspaces/{workspaceId}/plugins': {
    ...
    get: operations['ListWorkspacePlugins'];
    put?: never;
    post: operations['RegisterWorkspacePlugin'];
    delete?: never;
    options?: never;
    head?: never;
    patch?: never;
  ...
  '/api/v1/workspaces/{workspaceId}/plugins/components/upload': {
    parameters: {
      query?: never;
      header?: never;
      path?: never;
    ...
    get?: never;
    put?: never;
    post: operations['BeginPluginComponentUpload'];
    delete?: never;
    options?: never;
    head?: never;
    patch?: never;
  ...
  '/api/v1/workspaces/{workspaceId}/plugins/{installationId}/enabled': {
    parameters: {
      query?: never;
      header?: never;
      path?: never;
    ...
    get?: never;
    put: operations['SetWorkspacePluginEnabled'];
    post?: never;
    delete?: never;
    options?: never;
    head?: never;
  ...
  '/api/v1/workspaces/{workspaceId}/plugins/{installationId}/capabilities': {
    parameters: {
      query?: never;
      header?: never;
      path?: never;
    ...
    get?: never;
    put: operations['ReplaceWorkspacePluginCapabilities'];
    post?: never;
    delete?: never;
    options?: never;
    head?: never;
  ...
  '/api/v1/items/{itemId}/lock': {
     ...
     * @description Returns whether the item's body is behind a password and, when it is, until when the calling browser session or access token has it unlocked. A lock covers the item's whole subtree: a child of a locked item is locked too, and a locked item's children and views are withheld along with its body. 'lockItemId' names the item whose password opens this one next, and 'selfLocked' says whether the item has a lock of its own. A lock withholds content from anybody who has not unlocked it; it does not encrypt what is stored.
     */
...
export interface components {
  schemas: {
    ...
    BeginPluginComponentUploadRequest: {
      publisherId: string;
      id: string;
      version: string;
      sha256: string;
    ...
    ReplacePluginCapabilitiesRequest: {
      capabilities: string[];
    };
...
export interface operations {
  ...
  RegisterWorkspacePlugin: {
    ...
    requestBody: {
      content: {
        'application/json': components['schemas']['PluginComponentRegistrationRequest'];
      };
    };
    responses: {
      /** @description OK */
  ...
  BeginPluginComponentUpload: {
    ...
    requestBody: {
      content: {
        'application/json': components['schemas']['BeginPluginComponentUploadRequest'];
      };
    };
    responses: {
      /** @description OK */
      200: {
        ...
        content: {
          'application/json': components['schemas']['PluginComponentUploadResponse'];
        };
      };
      /** @description Bad Request */
      400: {
  ...
  ReplaceWorkspacePluginCapabilities: {
    parameters: {
      query?: never;
      header?: never;
      path: {
    ...
    requestBody: {
      content: {
        'application/json': components['schemas']['ReplacePluginCapabilitiesRequest'];
      };
    };
    responses: {
      /** @description OK */
